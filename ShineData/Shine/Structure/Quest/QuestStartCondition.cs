...
namespace ShineData.Shine.Structure.Quest
{
    public class QuestStartCondition
    {
        ...
        public CharacterClass Class { get; set; } = CharacterClass.CC_NONE;
        public bool RequiresGender { get; set; }
        public Gender Gender { get; set; } = Gender.G_FEMALE;
        public bool RequiresDateMode { get; set; }
        public QuestStartDateMode DateMode { get; set; } = QuestStartDateMode.QSDM_YEAR;
