...
public class AbStateEntry : IShineEntry
{
    ...
    public AbStateEntry(ushort id, string inxName, uint abstateIndex, uint keepTimeRatio, byte keepTimePower, byte stateGrade, 
