...
public class SubAbStateEntry : IShineEntry
{
    ...
    public SubAbStateEntry() {}
    
    public SubAbStateEntry(ushort id, string inxName, uint strength, uint type, byte subType, uint keepTime,
        uint actionIndex01, uint actionArg01, uint actionIndex02, uint actionArg02, uint actionIndex03, 
        uint actionArg03, uint actionIndex04, uint actionArg04)
    {
        Id = id;
        InxName = inxName;
        Strength = strength;
